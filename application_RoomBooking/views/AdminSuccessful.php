...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="135" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/cancelBooking/displayBooking">MODIFY/CANCEL BOOKING</a></strong></div></td>
    <td width="152" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>
 ...
 <tr>
    <td width="155" height="450" valign="top" bgcolor="#5C743D">
	<?php
	$userarray=$this->session->userdata('logged_in');
	if($userarray['username']==NULL)
	{?>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" id="navigation">
        ...
        <tr>
          <td width="199" height="67"><p align="center" class="quote style2">Username:<input name="username" type="text" class="username" />
            <br />
          </p>          </td>
        </tr>
        
        <tr>
          <td width="199" height="72"><p align="center" class="quote style2">Password:<br />
            ...
            <td height="58" align="center" valign="top" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div>
              <div><?php  if($userarray['username']!=NULL) {?>
				...
				<form action = "http://localhost/Lahad/admin/modifyRoom" method = "post">
                  <span class="subHeader style2">ADMIN PANEL: MODIFICATION SUCCESSFUL.</span><br />
				</form>          
              </div><?php } ?>
	...
	<?php }?> </td>
        ...
        <br />
        &nbsp;<br />
      </div></td><td width="135">&nbsp;</td>
 </tr>
  <tr>
    <td width="155" bgcolor="#99CC66">&nbsp;</td>
    <td width="54" bgcolor="#99CC66">&nbsp;</td>
    <td width="180" bgcolor="#99CC66">&nbsp;</td>
    <td width="72" bgcolor="#99CC66">&nbsp;</td>
    <td width="64" bgcolor="#99CC66">&nbsp;</td>
    <td width="140" bgcolor="#99CC66">&nbsp;</td>
	<td colspan="2" bgcolor="#99CC66">&nbsp;</td>
	<td width="135" bgcolor="#99CC66">&nbsp;</td>
  </tr>
</table>
</body>
</html>
