      ...
      <div align="right">
        <table width="601" height="374" border="0" align="center" cellpadding="0" cellspacing="5" bordercolor="#5C743D">
          <tr>
			...
			<div> Search for the Hotel </div>
				<form action = "http://localhost/Lahad/search/searchHotel" method = "post">
				<input name="search" type="text" class="search" placeholder="Enter your search Text here..." />
