...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="174" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/cancelBooking/displayBooking">MODIFY/CANCEL BOOKING</a></strong></div></td>
    <td width="158" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>
 ...
 <tr>
    <td width="190" height="450" valign="top" bgcolor="#5C743D">
	<?php
	$userarray=$this->session->userdata('logged_in');
	if($userarray['username']==NULL)
	{?>
        ...
        <tr>
          <td width="199" align="center" valign="top" bgcolor="#99CC66">&nbsp;
            <p><span class="style5">&nbsp;LOGIN</span><br />  
              <span class="style6">INVALID USERNAME/PASSWORD</span><br />          
          </p></td>
        </tr>
        <tr>
    ...
    <td colspan="6" align="center" valign="top" bordercolor="#5C743D" border = 1px>
      ...
      <div align="right">
        <table width="601" height="374" border="0" align="center" cellpadding="0" cellspacing="5" bordercolor="#5C743D">
          <tr>
          <?php $userarray=$this->session->userdata('logged_in');
		  $user=$userarray['username'];
		   $query = $this->db->query("SELECT isAdmin FROM users WHERE email='$user'");
		  $result=$query->row();
		  if($user==NULL || $result->isAdmin==0) {?>
            <td width="591" height="58" align="center" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div></td>
          </tr>
          
          <tr>
            <td valign="top" bordercolor="#5C743D" class="bodyText"><p>&nbsp;</p>
              <p>If any of you managed to find this place, well - its just a module demonstration for CS2102. Roam around and do tell us about any problems you might see.</p>
              <p>&nbsp;</p>
              <p align="center"><span class="subHeader"><em>Some of our &quot;imaginary&quot; locations</em>.</span></p>
              <p align="center"><span class="subHeader">THE LAHAD, NEW YORK</span></p>
              <p align="center"><span class="subHeader">THE LAHAD, BALI</span><br />
              </p>
            <p align="center"><span class="subHeader">THE LAHAD, NEW DELHI</span></p>          <p>&nbsp;</p></td><?php } ?>
            <?php if($user!=NULL && $result->isAdmin==1) { header('Location: http://localhost/Lahad/admin/display'); }?>
          </tr>
        </table>
        <br />
        &nbsp;<br />
      </div></td><td width="212">&nbsp;</td>
 </tr>
  <tr>
    <td width="190" bgcolor="#99CC66">&nbsp;</td>
    <td width="47" bgcolor="#99CC66">&nbsp;</td>
    <td width="171" bgcolor="#99CC66">&nbsp;</td>
    <td width="68" bgcolor="#99CC66">&nbsp;</td>
    <td width="110" bgcolor="#99CC66">&nbsp;</td>
    <td width="189" bgcolor="#99CC66">&nbsp;</td>
	<td colspan="2" bgcolor="#99CC66">&nbsp;</td>
	<td width="212" bgcolor="#99CC66">&nbsp;</td>
  </tr>
</table>
</body>
</html>
