...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="177" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>
            ...
            <td height="58" align="center" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div>
              <div>
                <form name="guestRegister" action="http://localhost/Lahad/registration/checkRegistration" class="input" method="post">
                  <label><span class="style3"><span class="style6">Your Account was Successfully Created.</span><br />
</span><span class="bodyText">The Details Of Your Account Are:</span><span class="style3"><br />
<br />
</span><span class="bodyText"><strong><?php echo('First Name: ');?></strong> <?php echo($firstname)?><br />
<strong> <?php echo('Last Name: ');?></strong> <?php echo($lastname)?><br />
<strong> <?php echo('Username/Email: ');?></strong> <?php echo($username)?></span><span class="style3"><br />
<br />
We will send you an e-mail shortly with your account details.<br />
<a href="http://localhost/Lagad/login">GO BACK</a><br />
                  </span></label>
                </form>
              </div></td>
          </tr>
