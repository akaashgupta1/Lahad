    ...
    <td colspan="6" align="center" valign="top" bordercolor="#5C743D" border = 1px>
      ...
      <div align="right">
        <table width="601" height="374" border="0" align="center" cellpadding="0" cellspacing="5" bordercolor="#5C743D">
          <tr>
            <div align="center" bordercolor="#5C743D" class="pageName"> Your search results for <?php echo $searchdata; ?> returned </div>
            <?php if($error == "False"): ?>
              <?php foreach($queryResult as $item):?>
                <tr><td height="58" valign="top" align="left" bordercolor="#5C743D" class="pageName">
                  <div> <a href=<?php echo "http://localhost/Lahad/processBooking/customer_book/".urlencode($item['city'])?>>
                    <?php echo "THE LAHAD, ".$item['city'] ;?> </a></div>
                </td></tr>
                <tr><td height="20" align="left" valign="top" id="dateformat">
                  <div> <?php echo $item['street'] ;?> </div>
                  <div> <?php echo $item['country'] ;?> </div>
                </td></tr>
              <?php endforeach ;?>
            <?php else: ?>
              <div> Sorry no results returned </div>
            <?php endif; ?>
            </td>
          </tr>
        </table>
