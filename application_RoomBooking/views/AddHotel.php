...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="165" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/cancelBooking/displayBooking">MODIFY/CANCEL BOOKING</a></strong></div></td>
 ...
 <tr>
    <td width="180" height="450" valign="top" bgcolor="#5C743D">
	<?php
	$userarray=$this->session->userdata('logged_in');
	if($userarray['username']==NULL)
	{?>
          ...
          <tr>
            <td height="58" align="center" valign="top" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div>
              ...
              <?php  if($userarray['username']!=NULL) {?>
				<form action = "http://localhost/Lahad/admin/addHotel" method = "post">
                  <label><span class="subHeader style2">ADMIN PANEL: Add Hotel.</span><span class="bodyText">
                  <?php if($results=='0') { ?><br />
