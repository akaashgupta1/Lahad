...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="188" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>
 ...
 <tr>
    ...
    <td colspan="6" valign="top" border = 1px bordercolor="#5C743D">
      ...
      <div align="right">
        <table width="637" height="628" border="0" align="center" cellpadding="0" cellspacing="5" bordercolor="#5C743D">
          <tr>
            <td width="591" height="45" align="center" bordercolor="#5C743D" class="pageName"><br /><div align="center">WELCOME PEEPS.</div></td>
          </tr>
          
          <tr><?php  if($userarray['username']!=NULL) {?>
            <td valign="top" bordercolor="#5C743D" class="bodyText"><p align="center" class="style3">Enter Your Booking Details Before:</p>
  ...
  <?php  if($userarray['username']==NULL) {?>
	 <td valign="top" bordercolor="#5C743D" class="bodyText"><p align="center" class="style3 style6">Please Login First.</p>
	<?php }?>
  ...
  <tr>
    ...
    <td width="161" bgcolor="#99CC66">&nbsp;</td>
