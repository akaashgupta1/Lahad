...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  <tr bgcolor="#D5EDB3">
    ...
    <p class="style2">&nbsp;</p></td>
    <td width="213" height="50">&nbsp;</td>
  </tr>

  <tr bgcolor="#D5EDB3">
    <td width="213" height="51">&nbsp;</td>
  </tr>
  ...
  <tr bgcolor="#99CC66">
    ...
    <td id="dateformat" height="20"><?php $userarray=$this->session->userdata('logged_in');
		  $user=$userarray['username'];
		   $query = $this->db->query("SELECT isAdmin FROM users WHERE email='$user'");
		  $result=$query->row();
		  if($user!=NULL && $result->isAdmin==1) {?><div align="center"><strong><a href="http://localhost/Lahad/admin/display">ADMIN PANEL</a></strong></div><?php } ?></td>
    ...
    <td width="187" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/cancelBooking/displayBooking">MODIFY/CANCEL BOOKING</a></strong></div></td>
    <td width="162" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>  
 ...
 <tr>
    <td width="215" height="450" valign="top" bgcolor="#5C743D">
	<?php
	$userarray=$this->session->userdata('logged_in');
	if($userarray['username']==NULL)
	{?>
    ...
    <td colspan="6" valign="top" border = 1px bordercolor="#5C743D">
      ...
      <div align="right">
        <table width="674" height="374" border="0" align="center" cellpadding="0" cellspacing="5" bordercolor="#5C743D">
          <tr><?php  if($userarray['username']!=NULL) {?>
            <td valign="top" bordercolor="#5C743D" class="bodyText"><p align="center"><span class="style6 style2">GREETINGS ADMIN</span><span class="style2">.<br />
                  <span class="style3">You can do the following:</span><br />
            </span><br />
            </p>
              <form action = "http://localhost/Lahad/admin/process" method = "post">
                <div align="center">
                  <input type = "radio" name = "query" value = "Add Hotel"/>
                  Add Hotel </br>
  </br>
  <br />
  <input type = "radio" name = "query" value = "Modify Hotel"/>
                  Modify Hotel </br>
  </br>
  <br />
  <input type = "radio" name = "query" value = "Delete Hotel"/>
                  Delete Hotel </br>
  </br>
  <br />
  <input type = "radio" name = "query" value = "Add Room"/> 
                  Add Room  </br> 
  </br>
  <br />
  <input type = "radio" name = "query" value = "Modify Room"/> 
                  Modify Room </br>
  <br /> 
  </br>
  <input type = "radio" name = "query" value = "Delete Room"/> 
                  Delete Room </br>
  <br /> 
  </br>
  <input type = "radio" name = "query" value = "Add User"/>
  				  Add User<br /> 
  				  </br> 
                  </br> 
<input type = "radio" name = "query" value = "Remove User"/>  
				Remove User<br />
				<br /> 
				</br> 
                </br>
  <input name="Submit" type = "submit" value="Submit" />
	...
	<?php }?>          
        ...
        <br />
        &nbsp;<br />
      </div></td><td width="213">&nbsp;</td>
 </tr>
  <tr>
    <td width="215" bgcolor="#99CC66">&nbsp;</td>
    <td width="28" bgcolor="#99CC66">&nbsp;</td>
    <td width="179" bgcolor="#99CC66">&nbsp;</td>
    <td width="126" bgcolor="#99CC66">&nbsp;</td>
    <td width="44" bgcolor="#99CC66">&nbsp;</td>
    <td width="165" bgcolor="#99CC66">&nbsp;</td>
	<td colspan="2" bgcolor="#99CC66">&nbsp;</td>
	<td width="213" bgcolor="#99CC66">&nbsp;</td>
  </tr>
</table>
</body>
</html>
