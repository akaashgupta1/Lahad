...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="182" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>
 ...
 <tr>
    <td width="183" height="450" valign="top" bgcolor="#5C743D">
	<?php
	$userarray=$this->session->userdata('logged_in');
	if($userarray['username']==NULL)
	{?>
    ...
    <td colspan="6" align="center" valign="top" bordercolor="#5C743D" border = 1px>
      ...
      <div align="right">
        <table width="601" height="374" border="0" align="center" cellpadding="0" cellspacing="5" bordercolor="#5C743D">
          <tr>
            <td height="58" align="center" valign="top" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div>
              <div><?php  if($userarray['username']!=NULL) {?>
				<form action = "http://localhost/Lahad/admin/modifyHotel" method = "post">
                  <label><span class="subHeader style2">ADMIN PANEL: Modify Hotel.</span><span class="bodyText">
                  <?php if($results=='0') { ?><br /><span class="style6"><span class="style6 style3">INCORRECT DETAILS ENTERED</span>.</span><br />
                  <?php } ?><br /><br />
<input name = "old_pincode" placeholder = "Pincode" /> </br> </br>
<input name = "old_city" placeholder = "City" /> </br> </br>

New Details of the Hotel [leave attributes blank to retain values][begin description with '+' to append] : </br> </br>
<input name = "name" placeholder = "Hotel Name" /> </br> </br>
...
<input name = "serial_no" placeholder = "Serial" /> </br> </br>
<input name = "street" placeholder = "Street" /> </br> </br>
<input type = "submit" value = "Change" />

</form>           </div><?php } ?>
  	<?php  if($userarray['username']==NULL) {?>
	<br /><p align="center" class="style3">Please Login First.</p>
	<?php }?>  </td>
          </tr>
        </table>
        <br />
  ...
  <tr>
    <td width="183" bgcolor="#99CC66">&nbsp;</td>
    <td width="45" bgcolor="#99CC66">&nbsp;</td>
    <td width="196" bgcolor="#99CC66">&nbsp;</td>
    <td width="87" bgcolor="#99CC66">&nbsp;</td>
    <td width="77" bgcolor="#99CC66">&nbsp;</td>
    <td width="168" bgcolor="#99CC66">&nbsp;</td>
