 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" id="navigation">
 	...
 	 <br />
  	...
  	&nbsp;<br /> 	</td>
    <td width="45">&nbsp;</td>
    <td colspan="6" align="left" valign="top" bordercolor="#5C743D" border = 1px>
          ...
          <tr>
            <td height="58" align="center" valign="top" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div>
              <div><?php  if($userarray['username']!=NULL) {?>
				<form action = "http://localhost/Lahad/admin/addRoom" method = "post">
                  <label><span class="subHeader style2">ADMIN PANEL: Add Room.</span><span class="bodyText">
                  <?php if($results=='0') { ?><br /><span class="style6 style3">INCORRECT DETAILS ENTERED.</span><br />
                  <?php } ?><br /><br />
