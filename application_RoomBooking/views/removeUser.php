...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#5C743D">
  ...
  <tr bgcolor="#99CC66">
    ...
    <td width="163" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/cancelBooking/displayBooking">MODIFY/CANCEL BOOKING</a></strong></div></td>
    <td width="181" height="20" id="dateformat"><div align="center"><strong><a href="http://localhost/Lahad/registration/register_user">REGISTER USER</a></strong></div></td>
          ...
          <tr>
            <td height="58" align="center" valign="top" bordercolor="#5C743D" class="pageName"><div align="center">WELCOME PEEPS.</div>
              <div><?php  if($userarray['username']!=NULL) {?>
				<form action = "http://localhost/Lahad/admin/removeUser" method = "post">
                  <label><span class="subHeader style2">ADMIN PANEL: Remove User.</span><span class="bodyText">
                  <?php if($results=='0') { ?><br /><span class="style6"><span class="style6 style3">INCORRECT DETAILS ENTERED</span>.</span><br />
                  <?php } ?><br /><br />
                  <span class="style3"></span>                  <span class="smallText"><span class="style3">Enter Email </span>:</span>
